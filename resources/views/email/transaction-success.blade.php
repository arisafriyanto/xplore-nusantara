                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="width:150px;">
                                                                <img src="{{ $message->embed(asset('frontend/images/logo-xplore@2x.png')) }}"
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="width:550px;">
                                                                <img alt="Image"
                                                                    src="{{ $message->embed(asset($data->travel_package->galleries[0]->image)) }}"
                                                                    style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;"
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td align="left"
                                                                ...
                                                                <div
                                                                    style="font-family:Assistant, Helvetica, Arial, sans-serif;font-size:18px;line-height:25px;text-align:left;color:#071c4d;">
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td align="center" bgcolor="#ff9e53"
                                                                                ...
                                                                                valign="middle">
                                                                                <a href="{{ route('checkout.index', $data->id) }}"
                                        ...
                                        <tr>
                                            <td align="center"
                                                ...
                                                <div
                                                    ...
                                                    2024 Nomads Copyright All Rights Reserved.</div>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
